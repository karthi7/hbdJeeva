...
},{"splitting":"Qdhu"}],"fb6s":[function(require,module,exports) {
"use strict";
...
class Slideshow {
  ...
  navigate(direction) {
    ...
    .to(currentSlide.DOM.imgs, {
      ...
      opacity: 0,
      stagger: 0.1
    }, 'start').addLabel('upcoming', 0.4).add(() => {
    ...
    .to(nextSlide.DOM.chars, {
      ...
      ease: 'power4',
      stagger: direction === 'next' ? -0.015 : 0.015
    }, 'upcoming') // Animate upcoming images in
...
},{"splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"yIBK","gsap":"TpQl","../slide":"Drnq"}],"4ZSz":[function(require,module,exports) {
"use strict";
...
},{"../utils":"8MgT","../cursor":"+9LM","./slideshow":"fb6s"}]},{},["4ZSz"], null)